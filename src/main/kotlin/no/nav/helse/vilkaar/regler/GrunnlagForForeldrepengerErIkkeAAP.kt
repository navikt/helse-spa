...
class GrunnlagForForeldrepengerErIkkeAAP : AbstractSpecification<Soknad>() {
    override fun evaluate(t: Soknad): Evaluation {
        return SingleEvaluation(Result.NO, "Grunnlag for foreldrepenger er ikke AAP", "ruleDescription", "Not implemented")    }
}